...
public class Person extends Point {
    ...
    private void action() {
        ...
        //横向运动边界
        if (getX() > city.getCenterX()+150 || getX() < city.getCenterX()-150 ) {
            moveTarget = null;
            /*if (udX > 0) {
                udX = -udX;
            }*/
            /*if(udX==0) {
            	setX(Constants.CITY1);
            	setY(Constants.CITY1);
            	return;
            }*/
            Random random = new Random();
            int x = (int) (100 * random.nextGaussian());
            int y = (int) (100 * random.nextGaussian());
            x = x%150+ this.city.getCenterX();
            y = y%150+ this.city.getCenterY();
            setX(x);
        	setY(y);
            //udX = -udX;
        }
        ...
        //纵向运动边界
        //if (getY() > city.getCenterY()+150 || getY() < 0) {
        if (getY() > city.getCenterY()+150 || getY() < city.getCenterY()-150) {
            moveTarget = null;
            /*if (udY > 0) {
                udY = -udY;
            }*/
